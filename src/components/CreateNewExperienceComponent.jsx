...
const CreateNewExperienceComponent = () => {
  ...
  const formSubmit = async () => {
    ...
    client_api.create("/api/dashboard/experience/create", {
      title,
      company,
      time_section,
      long_des,
      ...
      if (res.status === true) {
        router.replace("/dashboard/experience/all-experience");
        SuccessToast("Experience Create Success!");
        setSubmit(false);
      } else {
  ...
  return (
    <section>
      ...
      <div className="m-[30px] rounded-xl bg-[#36404A] p-[30px]">
        <h2 className="text-xl font-medium text-white">Add new experience</h2>
...
export default CreateNewExperienceComponent;
